...
In this design, FW inspection between the Spokes and On-Prem can be bypassed (default) or optionally activated.

This design provides On-Prem to AVS transit capabilities by default. However, when Global Reach is available, Global Reach will be preferred.
